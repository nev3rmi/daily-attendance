...
if ( ! class_exists( 'PB_Settings' ) ) {
	class PB_Settings {
		 ...
		 * @param array $args
		 */
		function register_taxonomy( string $tax_name, string $obj_name, array $args = [] ) {
		 ...
		 * @return string|mixed
		 */
		function generate_fields( array $settings = [], bool $post_id = false, bool $custom_style = true ) {
