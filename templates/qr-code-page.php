...
<div class="pbda-qr-container">
    <div class="pbda-qr-left">
        <h2 class="pbda-qr-heading"><?php esc_html_e('Your QR Code', 'daily-attendance'); ?></h2>
    ...
    <div class="pbda-qr-right">
        <h2 class="pbda-qr-heading"><?php esc_html_e('Scan QR Code', 'daily-attendance'); ?></h2>
        <div id="qrcode"></div>
...
jQuery(document).ready(function($) {
    const attendanceEndpoint = '<?php echo esc_url(rest_url('v1/qr-attendance/submit')); ?>';
    let html5QrCode;
